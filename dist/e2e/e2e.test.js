...
test_1.test.describe("Page d'accueil", () => {
    (0, test_1.test)("Présence du titre et contenu correct", (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
    ...
    (0, test_1.test)("Présence du lien vers la liste des articles", (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
        yield page.goto(BASE_URL);
...
test_1.test.describe("Page liste des articles", () => {
    ...
    (0, test_1.test)("Présence du bouton 'Nouvel article' et fonctionnement", (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
        yield page.goto(`${BASE_URL}/posts`);
...
test_1.test.describe("User Story : Création et modification d'un article", () => {
    let postId;
    (0, test_1.test)("Créer un article et vérifier sa présence", (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
    ...
    (0, test_1.test)("Modifier l'article et vérifier la mise à jour", (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
        if (!postId)
            test_1.test.skip(); // vérifie si on a un id correct
